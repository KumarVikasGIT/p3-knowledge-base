...
category: encryption
excerpt: Your encrypted photo data is stored using cloud object storage, with account and gallery metadata
  held in P3's database. The specific storage region should be confirmed here once finalized — this...
author: Vikas Kumbhakar
migration_original_status: DRAFT — legal claims pending review
migration_note: Per memory context, legal pages (privacy policy, terms) are still pending Indian legal
  review and unconfirmed business decisions (governing-law jurisdiction scope, DPDP Act 2023 posture).
  This article should not make compliance claims ahead of that review. Written to describe architecture
  factually and defer specific legal-status claims to the reviewed Privacy Policy.
---
