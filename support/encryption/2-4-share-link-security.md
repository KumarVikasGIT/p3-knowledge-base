...
route: /support/encryption/share-link-security
status: ready
priority: high
note: Must not overstate revocation guarantees. See canonical spec R6 — download-disable and link revocation are UX hints, not enforced controls.
---
