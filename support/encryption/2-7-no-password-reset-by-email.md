---
slug: no-password-reset-by-email
category: encryption
title: Why can't P3 reset my password and restore my photos?
route: /support/encryption/no-password-reset-by-email
status: ready
priority: high
note: Likely highest-traffic article at launch per content inventory. Should appear in popular articles list and be cross-linked from any forgot-password UI.
---
