...
route: /support/galleries/remove-collaborator
status: ready
priority: high
note: >
  Corrected from the original content plan. Removal is not instantaneous and silent —
  it triggers a mandatory key rotation that makes the entire gallery temporarily read-only
  for all remaining members. See p3_roles_permissions_spec and GALLERY_ROTATION_JOB
  in p3_backend_architecture_v1_1.
---
