...
category: delivery
excerpt: From a client's profile, select Assign gallery, choose the gallery you want to deliver, and set
  the permissions for this delivery — whether the client can download photos, and whether they can...
