...
category: galleries
excerpt: 'From an open gallery, use the upload screen to add photos. You can drag and drop files or select
  them manually. Supported formats: JPEG, PNG, HEIC, and RAW.'
