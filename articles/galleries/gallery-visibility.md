---
title: Public vs private galleries — what's the difference?
published: '2026-06-30'
category: galleries
excerpt: 'Every gallery has a privacy setting, found in Gallery → Settings: Private or Link-only.'
author: Vikas Kumbhakar
---

# Public vs private galleries — what's the difference?

Every gallery has a privacy setting, found in **Gallery → Settings**: **Private** or **Link-only**.

## Private

The default. Only people you've individually invited as collaborators (or, for Professional accounts, assigned as clients) can access the gallery. There's no link that grants access on its own — every viewer has to be specifically added.
