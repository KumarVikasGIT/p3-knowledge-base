...
excerpt: 'Account creation happens at `/register`. You''ll need:'
author: Vikas Kumbhakar
---

# How to create your account

Account creation happens at `/register`. You'll need:
...
1. Check your spam or promotions folder first.
2. Use the **resend** option on the verification screen.
3. Until your email is verified, some account features stay locked — this is a standard security measure, not a P3-specific restriction.
