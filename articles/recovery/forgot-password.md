...
- **If it doesn't** (new device, reinstalled app, or cleared browser storage), you'll be guided to a recovery screen to restore your key using your recovery phrase or backup password. See [What are my options if I lose access?](./7-1-recovery-options-overview.md) for that next step.
